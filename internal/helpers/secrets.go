...
func SetSecret(ctx context.Context, k client.Client, ref *prv1.SecretKeySelector, val string) error {
	if ref == nil {
...
func GetSecret(ctx context.Context, k client.Client, ref *prv1.SecretKeySelector) (string, error) {
	if ref == nil {
		return "", errors.New("no credentials secret referenced")
	}
...
func DeleteSecret(ctx context.Context, k client.Client, ref *prv1.SecretKeySelector) error {
	if ref == nil {
		return errors.New("no credentials secret referenced")
	}
